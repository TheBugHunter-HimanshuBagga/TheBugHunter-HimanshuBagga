...
Solved **168 problems** across arrays, strings, linked lists, trees, dynamic programming, and backtracking. Consistent daily practice with a **50-day streak badge (2026)**.
